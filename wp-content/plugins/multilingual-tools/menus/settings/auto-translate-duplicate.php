		...
		<td>
			<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
				...
				<ul class="holder">
					...
					<li><input type="checkbox" id="duplicate_strings_to_translate" name="duplicate_strings_to_translate[post][image-tags]" value="1" <?php checked( isset( $duplicate_strings['post']['image-tags'] ) ); ?> /><?php _e( 'Alt and title tags for images in content', 'wpml-compatibility-test-tools' ); ?></li>
					...
					<li><input type="checkbox" id="duplicate_strings_to_translate" name="duplicate_strings_to_translate[custom_fields][value]" value="1" <?php checked( isset( $duplicate_strings['custom_fields']['value'] ) ); ?> /><?php _e( 'Custom fields', 'wpml-compatibility-test-tools' ); ?></li>
